<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="college_index.aspx.cs" Inherits="学生信息管理系统.StudentsInfo.college_index" %>
...
<body>
    ...
    <div>
        <div class="header" style="background-color:tomato;">
            <div class="logo">
                <img src="../image/school.jpg" runat="server" />
            </div>
            <div class="title">
                <a runat="server" href="">学生管理系统</a>
                <br /><br />&nbsp;&nbsp;&nbsp;
                <span style="color:white;">欢迎您:</span>
                <asp:Label ID="lbusername" style="color:white" runat="server" Text=""></asp:Label>
            </div>
        ...
        <div class="left-nav" style="background-color:#f5f5f5">
            ...
            <ul class="menu">
                <%--<li class="one">
                <div><i class="iconfont icon-huanzheyilan"></i>学生管理</div>
                    <ul class="sub">
                        <li>
