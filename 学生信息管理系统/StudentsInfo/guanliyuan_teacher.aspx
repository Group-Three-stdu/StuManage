...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="编号" DataSourceID="SqlDataSource1" Height="40px" Width="85%" AllowPaging="True" AllowSorting="True" ForeColor="#333333" GridLines="None"  style="text-align:center;" HorizontalAlign="Center">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StulnfoConnectionString4 %>" SelectCommand="SELECT [编号], [密码], [姓名], [电话], [CollegeName], [Office] FROM [guanliyuan_teacher]"></asp:SqlDataSource>
    </form>
</body>
</html>
