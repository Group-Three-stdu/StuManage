<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="college_lookstu.aspx.cs" Inherits="学生信息管理系统.StudentsInfo.college_lookstu" %>
...
<body>
    ...
    <div>
        <div class="top">
            ...
            <asp:Button ID="btn_searchstu" runat="server" class="btn btn-success" Text="查询" style="height: 25px" OnClick="btn_searchstu_Click" />
            <br>
