...
<body >
    ...
    <div>
        ...
        <div class="btn"style="width:90%;margin-top:60px; ">
            <asp:LinkButton ID="btn_sub" CssClass="lbbtn btn btn-success pull-right" style="display:block;width:15%;position:relative;left:800px;"  runat="server" OnClick="btn_sub_Click">提交</asp:LinkButton>
        </div>
    </div>
